...
const Baithak = () => {
  return (
    <div className='overflow-hidden'>
        <Navbar/>
        <div className='w-full h-2/3 mt-14 md:mt-2' >
            <img className='w-full h-full  lg:h-[34rem] opacity-50' src='https://goonj.org/wp-content/uploads/2021/01/web-slider-baithak-1.jpg' alt=''/>
        </div>
        <div className='absolute top-20 md:top-32 lg:top-80 w-full mx-auto flex items-center justify-center hover:text-black  text-white text-lg lg:text-4xl leading-9 font-medium'>Baithak </div>
        
        <div className='md:w-8/12 mx-auto h-full flex  flex-col flex-wrap gap-7 border border-black m-10 p-5'>
            <div className='text-xl lg:text-3xl font-semibold'>Baithak – Enabling and Building connections to Co-learn and Collaborate</div>
            <div className='flex flex-col gap-4 text-wrap text-xs md:text-base font-normal'>
        ...
        <div className='md:w-8/12 h-full border mx-auto border-red-500 justify-center items-center text-sm md:text-lg lg:text-2xl font-medium px-10 py-8'>
        ...
        <div className='md:w-8/12 h-full mx-auto my-10 pb-10 border border-black'>
            <div className='m-5 flex flex-col text-sm md:text-base gap-4'>
                <div className='md:text-2xl font-medium'>Who can participate?</div>
                ...
                <div className='md:text-2xl font-medium'>Why Baithak?</div>
                <div className='flex flex-col gap-2'>

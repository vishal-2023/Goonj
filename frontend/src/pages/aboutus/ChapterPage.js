...
const ChapterPage = () => {
  return (
    <div className='overflow-hidden lazy-load'>
        ...
        <div className='w-full flex flex-row flex-wrap gap-7 my-10 item-center justify-center'>
            {
                Report1.map( (item)=>{
        ...
        <div className='w-full flex flex-row mb-8 flex-wrap gap-2 items-center justify-around '>
            {
                Report2.map( (item)=>{
                    return <Save id={item.id} className="active" {...item}/>
                })

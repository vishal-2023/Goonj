...
const FqPage = () => {
  return (
    <div className='overflow-hidden'>
        <Navbar/>
        <div className='w-full h-52 bg-[#212938] scale-125 mt-10' ></div>
        <div className='absolute top-32 w-full mx-auto flex items-center justify-center   text-white text-4xl leading-9 font-medium'>Frequently Asked Questions</div>

...
const AnnualPage = () => {
  return (
    <div className='overflow-hidden'>
        <Navbar/>
        <img className='w-full h-72  mt-3' src='https://goonj.org/wp-content/uploads/2019/02/annula-report-banner.jpg' alt='' />
        <div className='absolute top-32 w-full mx-auto flex items-center justify-center   text-white text-4xl leading-9 font-medium'>Annual Reports</div>
        <Link to="https://drive.google.com/file/d/1u3stEh7_ZVsKem0m1ARZn1yOzbiqwK4j/view">
            <img className='m-1/2 mx-auto w-[1050px] h-[500px] p-4' src='https://goonj.org/wp-content/uploads/2023/01/AR-website-banner.jpg' alt=''/>
        </Link>
        ...
        <div className='flex flex-col gap-5 items-center justify-center m-5 mt-9'>
            <div className='text-2xl font-semibold'>FCRA Balance Sheet</div>
            <div className='flex flow-row gap-6 items-center justify-center'>

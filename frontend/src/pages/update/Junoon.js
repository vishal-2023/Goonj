...
const Junoon = () => {
  return (
    <div className='bg-[#fcf7f7] w-full h-full'>
        ...
        <div className='bg-white w-10/12 mx-auto text-center flex flex-col items-center md:gap-10'>
            <div className='md:text-4xl text-lg mt-6 md:mt-0 text-red-600 font-medium'>Heartiest Congratulations to the Awardees, 2023 !!</div>
            <div className='md:border-4 border-red-400 md:w-5/6 p-3 md:py-10 flex justify-center'>
        ...
        <div className='flex flex-col justify-center items-center m-10 gap-10'>
            <div className='text-lg md:text-3xl font-semibold text-red-500'>Junoon Awards 2023 </div>
            <div className='md:w-full h-full '>
                <iframe className='md:w-1/2 lg:h-96 mx-auto'  src="https://www.youtube.com/embed/lIyWK5l7eT0?si=x0N04eTKoD3d4Ftl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        
        </div>
        <div className='w-2/5 h-0.5 bg-red-500   mx-auto' ></div>
        <div className='text-center m-10 text-base md:text-3xl font-medium text-red-500'>
        Award Ceremony held in Delhi on 20th August, 2023
        </div>
        <div className='flex flex-wrap md:w-full mx-auto justify-between gap-4'>
        {

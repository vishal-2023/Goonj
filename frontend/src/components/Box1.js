...
const Box1 = () => {
  return (
    <div className='w-full h-full flex flex-row justify-between gap-8 mx-6 py-10 '>
        <div className='w-[2400px] antialiased     px-10 h-[380px] flex flex-col py-20 items-center gap-1 justify-center border-4'>
            <div className='text-3xl font-semibold'>Our Mission & Vision</div>
            <div className='text-base mx-3 leading-5  font-normal '>Goonj aims to build an equitable relationship of strength, sustenance, and dignity between the cities and villages,
        ...
        <div className='mr-12'> 
            <img className='h-96 w-[2900px] ' src='https://goonj.org/wp-content/uploads/2018/06/Knowing-goonj_Vision.png' alt='' />
        </div>
    </div>
  )
}
